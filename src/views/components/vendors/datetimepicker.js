/**
 * Created by nailuoGG on 16/5/18.
 */
(function (a) {if (typeof define === "function" && define.amd) {define([ "jquery" ], a)} else {if (typeof exports === "object") {a(require("jquery"))} else {a(jQuery)}}}(function (f, c) {
  if (!("indexOf" in Array.prototype)) {
    Array.prototype.indexOf = function (k, j) {
      ...
      if (j < 0) {j = 0}
      for (var l = this.length; j < l; j++) {if (j in this && this[ j ] === k) {return j}}
      return -1
    }
  }
  function e (l) {
  ...
  i.prototype = {
    ...
    _attachEvents: function () {
      ...
      if (this.isInput) {
        ...
        } else {if (this.element.is("div")) {this.isInline = true} else {this._events = [ [ this.element, { click: f.proxy(this.show, this) } ] ]}}
      }
    ...
    setFormat: function (k) {
      ...
      var j;
      if (this.isInput) {j = this.element} else {if (this.component) {j = this.element.find("input")}}
